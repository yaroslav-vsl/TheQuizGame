...
void MainFrame::CreateDefaultQuestions()
{
    ...
    std::vector<Question> defaultQuestions = {
        {"Поезд длиной 1 км едет со скоростью 1 км/мин. Ему нужно проехать через тоннель длиной 1 км. За сколько минут поезд полностью проедет тоннель?", {"Лондон", "Берлин", "Париж", "Мадрид"}, 2, false},
        {"2 + 2?", {"3", "4", "5", "6"}, 1, false},
